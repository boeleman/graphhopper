 ...
 * @author Peter Karich
 */
public class MyBikeFlagEncoder extends BikeCommonFlagEncoder {
    public MyBikeFlagEncoder() {
        this(4, 2, 0);
    }

    public MyBikeFlagEncoder(String propertiesString) {
        this(new PMap(propertiesString));
    }

    public MyBikeFlagEncoder(PMap properties) {
    ...
    public MyBikeFlagEncoder(int speedBits, double speedFactor, int maxTurnCosts) {
        ...
        preferHighwayTags.add("living_street");
